...
class SleepsPage extends StatefulWidget {
  @override
  _SleepsPageState createState() => _SleepsPageState();
}

class _SleepsPageState extends State<SleepsPage> {
  ...
  getDataSource() async {
    ...
    List<Mark> _list;
    if(account != null) {
      _list = await DBAPI.sharedInstance.markDao.findMemberMarksByOpt("sleep");
    } else {
      _list = await DBAPI.sharedInstance.markDao.findLocalMarksByOpt("sleep");
    }
